  ...
  return (
    <div className="max-w-screen-2xl mx-auto pt-20 px-5">
      ...
      <div className="bg-white border border-gray-200 p-5 overflow-x-auto">
        ...
        <p className="mb-2">total: { singleOrder.subtotal }€</p>
        <p className="mb-2">
          Total: $
          {(singleOrder.subtotal + 5 + singleOrder.subtotal / 5).toFixed(2)}
        </p>
        <p className="mb-2">Statut: {singleOrder.orderStatus}</p>
        ...
        <table className="singleOrder-table min-w-full bg-white border border-gray-200">
          <thead>
            <tr>
              <th className="py-3 px-4 border-b">Nom du produit</th>
              <th className="py-3 px-4 border-b">Quantité</th>
